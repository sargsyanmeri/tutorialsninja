...
//         test('P-02 | Header search button is enabled', async({page})=>{
...
//         test('P-03 | Header search opens results page for iPhone', async({page})=>{
...
//         test('P-04 | Search for iPhone shows product cards',  async({page})=>{
//             page.locator('#search').getByPlaceholder('Search').fill(EXISTING_PRODUCT);
//             page.locator('#search').getByRole('button').click();
...
//         test('P-06 | Pressing Enter submits header search', async({page})=>{
//             await page.locator('#search').getByPlaceholder('Search').fill(EXISTING_PRODUCT);
...
//         test('P-07 | Search page has category filter', async({page})=>{
...
//         test('N-01 | Empty search shows no results message', async({page})=>{
...
//         test('N-02 | Empty search does not show product cards', async({page})=>{
//             await page.locator('#search').getByPlaceholder('Search').fill('');
//             await page.locator('#search').getByRole('button').click();
...
//         test('N-04 | Unknown product search does not show product cards', async({page})=>{
//             await page.locator('#search').getByPlaceholder('Search').fill(UNKNOWN_PRODUCT);
//             await page.locator('#search').getByRole('button').click();
...
//         test('N-05 | Search results do not contain fake product', async({page})=>{
//             await page.locator('#search').getByPlaceholder('Search').fill(EXISTING_PRODUCT);
//             await page.locator('#search').getByRole('button').click();
